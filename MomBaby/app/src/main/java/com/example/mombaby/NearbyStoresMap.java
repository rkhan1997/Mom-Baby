...
public class NearbyStoresMap extends FragmentActivity implements
        OnMapReadyCallback,
    ...
    public void onClick(View v)
    {
        ...
        GetNearbyStores getNearbyPlaces = new GetNearbyStores();
    ...
    private String getUrl(double latitide, double longitude, String nearbyPlace)
    {
        ...
        googleURL.append("&key=" + "AIzaSyC--iiFlkCvcLMDgvcaH6IVZHvxOBhuxpo0");
